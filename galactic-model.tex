...
\cite{hehl1976}     % For torsion-based gravity foundations
\cite{binney}       % For galactic dynamics textbook reference
\cite{hu2024}       % For recent gravitoelectric–gravitomagnetic interaction model
